...
-(void)layoutSubviews
{
    ...
    placeHolderLabel.frame = CGRectMake(8 + self.contentInset.left, 8 + self.contentInset.top, CGRectGetWidth(self.frame)-16, CGRectGetHeight(placeHolderLabel.frame));
}
